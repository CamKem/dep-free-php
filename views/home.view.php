...
<section>
    ...
    <ul class="product-grid">
        <li>
            ...
            >
                <article class="product-card">
                    <img src="./images/productImages/adidasEuro16TopSoccerBall.jpg"
        ...
        <li>
            ...
            >
                <article class="product-card">
                    <img src="./images/productImages/ProtecClassicSkateHelmet.png"
        ...
        <li>
            ...
            >
                <article class="product-card">
                    <img src="./images/productImages/NikeSport600mlWaterBottle.png"
        ...
        <li>
            ...
            >
                <article class="product-card">
                    <img src="./images/productImages/StingArmaPlusBoxingGloves.png"
        ...
        <li>
            ...
            >
                <article class="product-card">
                    <img src="./images/productImages/AsicsGelLethalTigreor8ITMens.jpg"
